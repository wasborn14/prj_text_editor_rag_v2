...
export const RAGPanel = ({ repository }: RAGPanelProps) => {
  ...
  return (
    <div
      className={`fixed top-[72px] bottom-0 bg-white border-l border-gray-200 shadow-xl transition-transform duration-300 ease-in-out z-40 flex
    ...
    >
      ...
      <div
        className="hidden md:block w-1 hover:w-2 cursor-col-resize bg-gray-200 hover:bg-blue-400 transition-all"
          ...
          <div className="flex items-center justify-between px-4 py-2">
            ...
            <div className="flex items-center space-x-1">
              ...
              <button
                ...
                className="hidden md:block p-1 rounded hover:bg-gray-200 text-gray-500 hover:text-gray-700"
